...
//
//class EnglishNumbersToWord(number: Int) {
//   var number = number
////   constructor(){
////      this.number = number
////   }
...
//   }
//
//   fun convert(number: EnglishNumbersToWord): String? {
...
//         0 -> ""
//         1 -> convertLessThanOneThousand(billions).toString() + " billion "
//         else -> convertLessThanOneThousand(billions).toString() + " billion "
//      }
//      var result = tradBillions
//      val tradMillions: String
//      tradMillions = when (millions) {
//         0 -> ""
//         1 -> convertLessThanOneThousand(millions).toString() + " million "
//         else -> convertLessThanOneThousand(millions).toString() + " million "
//      }
...
//         0 -> ""
//         1 -> "one thousand "
//         else -> convertLessThanOneThousand(hundredThousands).toString() + " thousand "
//      }
